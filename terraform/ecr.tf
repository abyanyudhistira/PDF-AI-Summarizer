...
# Repository untuk Docker images

# ECR Repository untuk Frontend
...
# ECR Repository untuk AI Service
...
# Lifecycle policy - hapus old images untuk save storage
